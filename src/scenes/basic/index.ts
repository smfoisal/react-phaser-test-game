...
export default class Basic extends Phaser.Scene {
	...
	preload = () => {
		...
		this.load.image("sky", "https://i.imgur.com/8azUxj5.png");
		this.load.image("ground", "https://i.imgur.com/oFDZuht.png");
		this.load.image("star", "https://i.imgur.com/gDMjS2i.png");
		this.load.image("bomb", "https://i.imgur.com/DRHhLNc.png");
		this.load.spritesheet("dude", "https://i.imgur.com/YG4L7cO.png", {
			frameWidth: 32,
			frameHeight: 48,
		});
	};
